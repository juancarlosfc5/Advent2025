        ...
        <div className="p-6 md:p-8 overflow-y-auto custom-scrollbar">
            ...
            {card.spotifyUrl && (
                ...
                >
                    ...
                    {card.spotifyUrl.includes('youtube.com') || card.spotifyUrl.includes('youtu.be') ? (
            ...
            {!card.spotifyUrl && (
                <div className="flex items-center gap-3 text-xl md:text-2xl font-bold text-christmas-darkRed mb-4">
                    <span>{card.title}</span>
                </div>
            )}
